...
\begin{itemize}
    ...
    \begin{itemize}
        \item Object distance from the lens ($d_o$)
    \end{itemize}

    \item \textbf{Dependent Variable:}
    \begin{itemize}
        \item Image position relative to the screen (retina)
        \item Image clarity on the screen
    \end{itemize}

    \item \textbf{Control Variables:}
    \begin{itemize}
        \item Lens type and focal length
